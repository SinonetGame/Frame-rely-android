package com.k365.frame.rely.chain

import com.k365.frame.rely.add
import com.k365.frame.rely.async
import com.k365.frame.rely.childCoroutine
import com.k365.frame.rely.launch
...
class Chain<E>(cause: Knot<*, E>) {
    ...
    init {
        alias = "CHAIN-${com.k365.frame.rely.currentTimeMillis}"
        _cause = cause
        findOrigin(cause)
    }
